...
export default function Chat(){
 ...
 const loadMessages=()=>selected?api(`/api/conversations/${selected}/messages`).then(data=>{setMessages(data);window.dispatchEvent(new Event('classificaja:refresh-notifications'))}).catch(e=>setErr(e.message)):setMessages([]);
