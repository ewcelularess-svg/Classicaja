...
app = FastAPI(title="ClassificaJá API", version="2.18.6")
...
@app.get("/api/health")
def health():
    return {"ok": True, "service": "ClassificaJá", "version": "2.18.6", "database": "postgresql" if USE_POSTGRES else "sqlite", "storage": "supabase" if USE_SUPABASE_STORAGE else "local"}
